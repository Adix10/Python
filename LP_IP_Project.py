...
df = pd.read_csv("F:\\LP PROJECT\\LP PROJECT.csv",index_col=0)
net = 0

print("==========================================================================================")
print("                                𝐋.𝐏. 𝐂𝐀𝐑 𝐒𝐇𝐎𝐖𝐑𝐎𝐎𝐌                               ")
print("==========================================================================================")
while True:
        ...
        if ch == 1:
            ...
            if prc > 6:
                ...
                if bill == "y":
                    ...
                    print("")
                    print("======================================================================")
                    billdf = pd.DataFrame({'𝐂𝐚𝐫': itemls, '𝙌𝙐𝘼𝙉𝙏𝙄𝙏𝙔': qtyls, '𝘼𝙈𝙊𝙐𝙉𝙏': amtls})
                    print(tabulate(billdf,headers='keys',tablefmt='psql'))
                    print('𝙔𝙤𝙪𝙧 𝙩𝙤𝙩𝙖𝙡 𝙬𝙤𝙪𝙡𝙙 𝙗𝙚:', net)
                    print("")
                    rating = float(input("\n𝙋𝙡𝙚𝙖𝙨𝙚 𝙧𝙖𝙩𝙚 𝙪𝙨 𝙤𝙪𝙩 𝙤𝙛 5 : "))
                    if 1 <= rating <= 5:
                        if rating >= 4:
                            print("𝐓𝐡𝐚𝐧𝐤𝐮 𝐟𝐨𝐫 𝐑𝐚𝐭𝐢𝐧𝐠! 𝐏𝐥𝐞𝐚𝐬𝐞 𝐯𝐢𝐬𝐢𝐭 𝐚𝐠𝐚𝐢𝐧 : ")
                        else:
